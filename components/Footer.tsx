      ...
      <div className="container mx-auto px-6 lg:px-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 lg:gap-24">
          <div className="col-span-1 md:col-span-2">
            <Link to="/">
              <img src={BRAND.logo} alt="AK BROTHERS" className="h-20 mb-10 opacity-90 hover:opacity-100 transition-opacity" />
            </Link>
            ...
            <div className="flex space-x-6 mt-12">
              ...
              <a href="#" className="text-silver hover:text-gold transition-all hover:scale-110"><Youtube size={24} /></a>
        ...
        <div className="mt-24 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] tracking-[0.5em] uppercase text-platinum/40 font-cinzel">
