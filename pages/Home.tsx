    ...
    <div ref={containerRef} className="bg-obsidian">
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 perspective-1000">
          ...
          <h1 className="font-cinzel text-5xl md:text-9xl text-white mb-12 tracking-tighter flex flex-wrap justify-center items-center">
            <div className="flex">{renderLetters("AK")}<span className="inline-block">&nbsp;</span><span className="text-gold italic flex">{renderLetters("BROTHERS")}</span></div>
          </h1>
      ...
      <section className="py-40 px-6 reveal text-center">
        <div className="max-w-4xl mx-auto">
           ...
           <p className="text-platinum/40 text-xs md:text-sm font-light tracking-[0.3em] leading-loose uppercase max-w-2xl mx-auto">Bhopal's premier wedding cinematography studio. We specialize in luxury storytelling.</p>
        </div>
      </section>
