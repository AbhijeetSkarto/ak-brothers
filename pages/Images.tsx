  ...
  return (
    <div className="pt-28 md:pt-40 min-h-screen bg-cream">
      <section className="px-4 md:px-10 lg:px-20 mb-12 md:mb-20 text-center">
        <span className="text-gold font-cinzel text-[11px] tracking-[1em] uppercase mb-4 md:mb-6 block opacity-80">Visual Stills</span>
        <h2 className="font-cinzel text-5xl md:text-[10rem] text-obsidian tracking-tighter leading-none">PORTRAITS</h2>
      </section>
